import{S as t,B as o}from"./454b3885.js";import{i as r,e}from"./1bd6a5fb.js";var c=r`
...
`,u=Object.defineProperty,s=Object.getOwnPropertyDescriptor,n=(t,o,r,e)=>{for(var c,n=e>1?void 0:e?s(o,r):o,a=t.length-1;a>=0;a--)(c=t[a])&&(n=(e?c(o,r,n):c(n))||n);return e&&n&&u(o,r,n),n};const a=["accent","primary","secondary","negative","white","black"];class b extends(t(o)){constructor(){super(...arguments),this._variant="accent",this.treatment="fill"}static get styles(){return[...super.styles,c]}get variant(){return this._variant}set variant(t){if(t!==this.variant){switch(this.requestUpdate("variant",this.variant),t){case"cta":this._variant="accent";break;case"overBackground":return this.removeAttribute("variant"),this.static="white",void(this.treatment="outline");case"white":case"black":return this.static=t,void this.removeAttribute("variant");case null:return;default:a.includes(t)?this._variant=t:this._variant="accent"}this.setAttribute("variant",this.variant)}}set quiet(t){this.treatment=t?"outline":"fill"}firstUpdated(t){super.firstUpdated(t),this.hasAttribute("variant")||this.setAttribute("variant",this.variant)}}n([e()],b.prototype,"variant",1),n([e({type:String,reflect:!0})],b.prototype,"static",2),n([e({reflect:!0})],b.prototype,"treatment",2),n([e({type:Boolean})],b.prototype,"quiet",1),customElements.define("sp-button",b);
