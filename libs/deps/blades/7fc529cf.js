import{i as t,x as o,e as c}from"./1bd6a5fb.js";import{t as r,I as e,s as n,S as a,B as s}from"./454b3885.js";var u=t`
...
`;customElements.define("sp-icon-corner-triangle300",class extends e{render(){return n(o),(({width:t=24,height:o=24,title:c="Corner Triangle300"}={})=>r`<svg
  ...
  >
    ...
    />
  </svg>`)()}});var d=Object.defineProperty,l=Object.getOwnPropertyDescriptor,b=(t,o,c,r)=>{for(var e,n=r>1?void 0:r?l(o,c):o,a=t.length-1;a>=0;a--)(e=t[a])&&(n=(r?e(o,c,n):e(n))||n);return r&&n&&d(o,c,n),n};const m={xs:"spectrum-UIIcon-CornerTriangle75",s:"spectrum-UIIcon-CornerTriangle75",m:"spectrum-UIIcon-CornerTriangle100",l:"spectrum-UIIcon-CornerTriangle200",xl:"spectrum-UIIcon-CornerTriangle300"};let p;class v extends(a(s,{validSizes:["xs","s","m","l","xl"]})){constructor(){super(),this.emphasized=!1,this.holdAffordance=!1,this.quiet=!1,this.role="button",this.selected=!1,this.toggles=!1,this._value="",this.onClick=()=>{this.toggles&&(this.selected=!this.selected,this.dispatchEvent(new Event("change",{cancelable:!0}))||(this.selected=!this.selected))},this.addEventListener("click",this.onClick),this.addEventListener("pointerdown",this.onPointerdown)}static get styles(){return[...super.styles,u,i]}get value(){return this._value||this.itemText}set value(t){t!==this._value&&(this._value=t||"",this._value?this.setAttribute("value",this._value):this.removeAttribute("value"))}get itemText(){return(this.textContent||"").trim()}onPointerdown(t){0===t.button&&(this.addEventListener("pointerup",this.onPointerup),this.addEventListener("pointercancel",this.onPointerup),p=setTimeout((()=>{this.dispatchEvent(new CustomEvent("longpress",{bubbles:!0,composed:!0,detail:{source:"pointer"}}))}),300))}onPointerup(){clearTimeout(p),this.removeEventListener("pointerup",this.onPointerup),this.removeEventListener("pointercancel",this.onPointerup)}handleKeydown(t){if(!this.holdAffordance)return super.handleKeydown(t);const{code:o,altKey:c}=t;("Space"===o||c&&"ArrowDown"===o)&&(t.preventDefault(),"ArrowDown"===o&&(t.stopPropagation(),t.stopImmediatePropagation()),this.addEventListener("keyup",this.handleKeyup),this.active=!0)}handleKeyup(t){if(!this.holdAffordance)return super.handleKeyup(t);const{code:o,altKey:c}=t;("Space"===o||c&&"ArrowDown"===o)&&(t.stopPropagation(),this.dispatchEvent(new CustomEvent("longpress",{bubbles:!0,composed:!0,detail:{source:"keyboard"}})),this.active=!1)}get buttonContent(){const t=super.buttonContent;return this.holdAffordance&&t.unshift(o`
                <sp-icon-corner-triangle300
                    class="hold-affordance ${m[this.size]}"
                ></sp-icon-corner-triangle300>
            `),t}updated(t){super.updated(t);const o="button"===this.role&&(this.selected||this.toggles);(t.has("selected")||t.has("role"))&&(o?this.setAttribute("aria-pressed",this.selected?"true":"false"):this.removeAttribute("aria-pressed"))}}b([c({type:Boolean,reflect:!0})],v.prototype,"emphasized",2),b([c({type:Boolean,reflect:!0,attribute:"hold-affordance"})],v.prototype,"holdAffordance",2),b([c({type:Boolean,reflect:!0})],v.prototype,"quiet",2),b([c({reflect:!0})],v.prototype,"role",2),b([c({type:Boolean,reflect:!0})],v.prototype,"selected",2),b([c({type:Boolean,reflect:!0})],v.prototype,"toggles",2),b([c({reflect:!0})],v.prototype,"variant",2),b([c({type:String})],v.prototype,"value",1),customElements.define("sp-action-button",v);
